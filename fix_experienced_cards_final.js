...
// Create a backup
fs.writeFileSync(
  path.join(__dirname, "public", "cards_v2_before_experienced_final_fix.json"),
  JSON.stringify(cards, null, 2)
);
console.log("Created backup before experienced final fixes");
...
// Main processing
console.log("\n=== FIXING EXPERIENCED CARDS FINAL ===");
