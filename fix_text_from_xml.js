...
// Function to extract text from XML card (excluding keywords)
function extractTextFromXmlCard(xmlCard) {
...
// Function to extract keywords from XML card
function extractKeywordsFromXmlCard(xmlCard) {
...
for (const card of cards) {
  ...
  const xmlText = extractTextFromXmlCard(xmlCard);
  const xmlKeywords = extractKeywordsFromXmlCard(xmlCard);
